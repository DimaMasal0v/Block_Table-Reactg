    ...
    <header className="text-white bg-gray-400 relative">
        <div className="flex justify-between items-center px-4">
            ...
            <div className="menu__container">
                <div className="menu__mobile-btn" id="menuBtn">
                    <div className="menu__burger"></div>
                </div>
                <div className="menu__overlay sm:top-1/2 sm:left-1/2 left-36 top-2/4 h-full sm:max-w-4xl max-w-full">
                    <div className="menu__close-btn sm:text-8xl text-4xl" id="closeBtn">
                        &times;
                    </div>
